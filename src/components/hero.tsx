    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <h1 className="text-6xl sm:text-[70px] md:pl-20 font-extrabold sm:leading-[70px] mb-5 lg:mb-8">
            FIND CLOTHES THAT MATCHES YOUR STYLE
          </h1>
          <p className="text-black/60 text-sm md:pl-20 lg:text-base mb-6 lg:mb-8 max-w-[545px] ">
            Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.
          </p>
          <div>
            <button className="w-full md:w-52 mb-5 md:mb-12 inline-block items-start text-center bg-black hover:bg-black/80 transition-all text-white px-16 py-4 rounded-full md:ml-20">
              Shop Now
            </button>
          </div>
          <div className="flex md:h-full md:max-h-11 lg:max-h-[52px] xl:max-h-[68px] items-center justify-center md:justify-start flex-wrap sm:flex-nowrap md:space-x-3 lg:space-x-6 xl:space-x-8 md:mb-[116px]">
            <div className="flex flex-col">
              <span className="font-bold text-2xl md:text-xl lg:text-3xl xl:text-[40px] xl:mb-2 md:pl-20">
                200+
              </span>
              <span className="text-xs xl:text-base text-black/60 text-nowrap md:pl-20">
